...
export default class CoustomerLogin extends Component {
  constructor(){
    super()
    this.state={
      username : '',
    ...
    <Modal
      ...
      <View style={{flex: 1,backgroundColor: "#fff"}}>
        ...
        <View style={{flex:0.2,justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontSize:RFValue(20),fontWeight:"bold",color:"#32867d"}}> User Sing Up </Text>
          </View>
    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'#EEEEEE', fontSize:18, fontWeight:'bold',marginLeft:55}}>USERNAME</Text>
